            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="contact-head">
                        <h3>Pošaljite nam <span class="color">Poruku</span></h3>
                        <p>Naš cilj je da Vama kao našoj mušteriji obezbedimo vrhunski osećaj u objektu nakon naše posete. Kao deo toga, mi vam dajemo garanciju na naš rad. Ukoliko ima nekih primedbi na obavljen posao
                            potrebno je da nas obavestite ne kasnije od jednog dana nakon završetka posla. Naša ekipa će doći i popraviti greške potpuno besplatno.
                        </p>
                        <div class="project-share">
                            <h5>Možete nas naći na:</h5>
                    ...
                    <div class="contact-form">
                        <div class="row">
                            <form id="form" method="post" enctype="multipart/form-data" class="contact-form">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" id="subject" name="subject" class="form-control" placeholder="Naslov:" onblur="$(this).valid()">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                    <button type="submit" id="submit" class="contact-btn">Pošalji</button>
