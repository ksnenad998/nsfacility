            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="page-head-left">
                    ...
                    <div class="single-page-head">
                        <div class="left-menu">
                            <ul>
                                <li><a href="fastighetsskotsel.php">Fastighetsskötsel</a></li>
                                <li><a href="kontorsstadning.php">Kontorsstädning</a></li>
                                <li  class="active"><a href="ffonsterputs.php">Fönsterputs</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
