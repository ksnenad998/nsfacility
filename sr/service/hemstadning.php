            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="page-head-left">
                    ...
                    <div class="single-page-head">
                        <div class="left-menu">
                            <ul>
                                <li class="active"><a href="hemstadning.php">Hemstädning</a></li>
                                <li><a href="storstadning.php">Storstädning</a></li>
                                <li><a href="flyttstadning.php">Flyttstädning</a></li>
                                <li><a href="fonsterputs.php">Fönsterputs</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
