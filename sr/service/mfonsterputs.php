                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="page-head-left">
                        ...
                        <div class="single-page-head">
                            <div class="left-menu">
                                <ul>
                                    <li><a href="mhemstadning.php">Hemstädning</a></li>
                                    <li><a href="mstorstadning.php">Storstädning</a></li>
                                    <li><a href="mflyttstadning.php">Flyttstädning</a></li>
                                    <li class="active"><a href="mfonsterputs.php">Fönsterputs</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
